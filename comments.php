...
<section class="m-8">
            ...
            <div>
                ...
                <h2 class="text-4xl font-bold my-6">
                    ...
                    if (!have_comments()) {
                        ...
                        printf(
                            _x('One reply on &ldquo;%s&rdquo;', 'comments title', 'blankslate'),
    ...
    if (comments_open() || pings_open()) {
        ...
        $comment_field = '<fieldset class="fieldset"><legend class="fieldset-legend"><label for="comment" class="label">
                     <span class="label-text">' . _x('Comment', 'comment-label', 'blankslate') . ($req ? $required : '') . '</span></label></legend>';
        $comment_field .= '<textarea id="comment" name="comment"
                        class="textarea textarea-bordered textarea-lg w-full max-w-xs"
                        aria-required="true"></textarea></fieldset>';
        comment_form(
            [
                'fields' => $fields,
